...
export const RecordingFilters: React.FC<Props> = ({ 
  ...
  const allCategories = [...new Set([...PRESET_CATEGORIES.map(c => c.id), ...categories])];
    ...
    <View style={styles.container}>
      <View style={styles.section}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          >
            <Ionicons name="time-outline" size={16} color={selectedFilter === 'recent' ? '#fff' : '#666'} />
          ...
          >
            <Ionicons name="timer-outline" size={16} color={selectedFilter === 'duration' ? '#fff' : '#666'} />
            <Text style={[styles.filterText, selectedFilter === 'duration' && styles.activeFilterText]}>Duration</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
